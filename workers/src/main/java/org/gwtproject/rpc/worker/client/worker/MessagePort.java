...
public class MessagePort {
	...
	@JsOverlay
	public final void addMessageHandler(MessageEvent.MessageHandler handler) {
		addEventListener("message", handler);
	}

	public native void addEventListener(String type, MessageEvent.MessageHandler listener);
